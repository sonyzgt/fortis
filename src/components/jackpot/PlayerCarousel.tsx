...
export const RightWinnerSidebar: React.FC<RightWinnerSidebarProps> = ({ pastRounds, className = '' }) => {
  ...
  return (
    <aside className={`w-[275px] flex-shrink-0 flex flex-col bg-[#A4BAA2]/75 dark:bg-[#0e1914]/85 backdrop-blur-2xl border-l border-white/60 dark:border-[#718D76]/30 h-full overflow-y-auto transition-colors ${className}`}>
      {/* Last Winners Header */}
