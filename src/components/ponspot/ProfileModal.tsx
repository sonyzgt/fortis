        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-black/10 dark:border-white/10">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-sm font-black tracking-tight">EDIT PLAYER PROFILE</h3>
                <p className="text-[10px] text-[#526256] dark:text-slate-400 font-mono">Customize your nickname & avatar</p>
              </div>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="p-4 rounded-2xl bg-white/60 dark:bg-[#14241d]/70 border border-white/80 dark:border-[#718D76]/30 flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1 space-y-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-sm font-black truncate">{name || 'Player Name'}</span>
                ...
                <p className="text-[10px] font-mono text-[#526256] dark:text-slate-400 truncate">
                  {account ? `${account.slice(0, 8)}...${account.slice(-6)}` : 'Wallet not connected'} • {userStats.gamesPlayed} Games Played
                </p>
              </div>
            </div>
              ...
              {activeTab === 'upload' && (
                <div className="p-4 rounded-2xl bg-white/40 dark:bg-[#101c16]/50 border border-black/5 dark:border-white/5 text-center">
                  ...
                  >
                    ...
                    <span className="text-xs font-bold">Select image file from your device</span>
                    <span className="text-[10px] text-[#526256] dark:text-slate-400">PNG, JPG, SVG max 2MB</span>
                  </button>
                </div>
              )}
            </div>
